...
/***************************************************************************
 Camposphere
                                 A QGIS plugin
 Permet d'extraire les batiments modulaire dans une parcelle cadastrale dont 
 on donne l'adresse.
...
class Camposphere:
    ...
    def load_shapefile_BM(self):
        ...
        file_dialog.setNameFilter("Shapefiles (*.shp));;GeoPackage (*.gpkg)")
    ...
    def load_shp_Cadastre(self):
        file_dialog = QFileDialog()
        file_dialog.setFileMode(QFileDialog.FileMode.ExistingFiles)
        file_dialog.setNameFilter("Shapefiles (*.shp));;GeoPackage (*.shp)")
        file_dialog.setViewMode(QFileDialog.ViewMode.List)
